...
type Module struct {
	...
	GetRealtimeQuotes  func(ctx context.Context, params QuoteParams) ([]common.QuoteItem, error)
	GetLatestQuote     func(ctx context.Context, codes []string) ([]common.QuoteItem, error)
